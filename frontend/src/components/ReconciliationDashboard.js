...
const ReconciliationDashboard = ({ comparables }) => {
  ...
  const handlePairedSales = async () => {
    ...
    try {
      const response = await axios.post('https://sensitivity-analysis-backend.onrender.com/api/paired-sales', {
  ...
  const handleDepreciatedCost = async () => {
    ...
    try {
      const response = await axios.post('https://sensitivity-analysis-backend.onrender.com/api/depreciated-cost', {
  ...
  const handleMarketRatio = async () => {
    ...
    try {
      const response = await axios.post('https://sensitivity-analysis-backend.onrender.com/api/market-ratio', {
